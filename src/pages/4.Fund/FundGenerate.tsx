...
const WalletTransfer: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-4">
      {/* <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white px-6 py-4 w-full text-center mb-10">
        <h1 className="text-xl font-medium text-white">Fund Generate</h1>
      </div> */}
      <div className="max-w-4xl mx-auto px-4">
        {/* Transfer Type Selector */}
        <div className="bg-gray-200 rounded-lg shadow-md p-2 mb-4">
          <label className="block text-center text-xl font-semibold text-white mb-4 px-4 py-2 rounded bg-gradient-to-r from-blue-600 to-blue-900">
